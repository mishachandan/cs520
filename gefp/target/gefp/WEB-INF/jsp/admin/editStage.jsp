            ...
            <div id="lower">
                <div id="low-docs">
                    <div class="curved container">
                        <h4><a href="../reloadlogin.html"> Golden Eagle Flight Plan </a> ><a href="viewPlan.html?planId=${sessionScope.sessionPlanId}&deptId=${sessionScope.sessionDeptId}" >View Plan </a>  > <a href="saveStage.html">Create Stage</a> > Edit Stage
                        ...
                        <h3 style="float:right">
                        	<%-- <a href ="${tomcatDocUrl}createPlan.html?deptId=1" >Create Plan </a> &nbsp; | &nbsp;  --%>
		                        ...
		                        <p>	
		                        	<form:form modelAttribute="stage" method="POST" >
		                        	<table>
		                        		<tr>
		                        			<td>Stage Name: </td>
