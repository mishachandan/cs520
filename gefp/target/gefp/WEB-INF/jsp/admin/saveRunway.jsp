            ...
            <div id="lower">
                <div id="low-docs">
                    <div class="curved container">
                        <h4><a href="../reloadlogin.html"> Golden Eagle Flight Plan </a> > <a href="viewPlan.html?planId=${sessionScope.sessionPlanId}&deptId=${sessionScope.sessionDeptId}" >View Plan </a> > Create Runway
                         <input type="button" value="Logout" style="float:right;"  onclick="location.href='../j_spring_security_logout'" />  </h4> <!-- logout.html -->
                        <h3 style="float:right">
                        	<%-- <a href ="${tomcatDocUrl}createPlan.html?deptId=1" >Create Plan </a> &nbsp; | &nbsp;  --%>
		                        ...
		                        <p>	
		                        	<form:form  modelAttribute="runway" method="POST" >
		                        	<table>
		                        		<tr>
		                        			<td>Runway Name: </td>
		                        			<td><form:input path="desc"  type="text"/>
		                         ...
		                         <p>	
		                         		<c:if test="${not empty  runwayList}" >
			                         		...
			                         		<table>
			                        			<tr>
			                         			...
			                         			<c:forEach items="${runwayList}" var="runwayObject">
			                         			<tr>
			                         				
			                         				<td>${runwayObject.desc }</td>
			                         				<td><a href="<c:url value='editRunway.html?runwayId=${runwayObject.runwayId}' />" >Edit</a> </td>
			                         			</tr>
			                         			</c:forEach>
			                         		</table>
		                         		</c:if>
