            ...
            <div id="lower">
                <div id="low-docs">
                    <div class="curved container">
                        <h4><a href="../reloadlogin.html"> Golden Eagle Flight Plan </a> ><a href="viewPlan.html?planId=${sessionScope.sessionPlanId}&deptId=${sessionScope.sessionDeptId}" >View Plan </a>  > Create Stage
                        ...
                        <h3 style="float:right">
                        	<%-- <a href ="${tomcatDocUrl}createPlan.html?deptId=1" >Create Plan </a> &nbsp; | &nbsp;  --%>
		                        ...
		                        <p>	
		                        	<form:form action="saveStage.html" modelAttribute="stage" method="POST" >
		                        	<table>
		                        		<tr>
		                        			<td>Stage Name: </td>
		                         		...
		                         		<c:if test="${not empty  stageList}" >
			                         		...
			                         		<table>
			                        			<tr>
			                         			...
			                         			<c:forEach items="${stageList}" var="stageObject">
			                         			<tr>
			                         				
			                         				<td>${stageObject.desc }</td>
			                         				<td><a href="<c:url value='editStage.html?stageId=${stageObject.stageId }' />" >Edit</a> </td>
			                         			</tr>
			                         			</c:forEach>
			                         		</table>
		                         		</c:if>
