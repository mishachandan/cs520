						...
						<li><a href="#">Home</a>
						  <div>
						  	<ul style="width:113px;">
								...
								<a href="<c:url value='/advisor/viewStudents.html'/>" style="width:113px;">Advisor View</a></li>
								</security:authorize>
            ...
            <div id="lower">
                <div id="low-docs">
                    <div class="curved container">
                        <h4> Golden Eagle Flight Plan <input type="button" value="Logout" style="float:right;"  onclick="location.href= '../j_spring_security_logout'"/> <!-- location.href='../logout.html' --> </h4>
                       
                        <h3 style="float:right">
                        	
                        	
                        	<a href ="#" id="hrefCreate" onclick="callCreate('${tomcatDocUrl}admin/createPlan.html');">Create Plan </a> &nbsp; | &nbsp; 
				                        				...
				                        				<c:forEach items="${department.associatedPlans}" var="associatedPlan">
															<tr>
					                        					...
					                        					<td>
					                        						...
					                        						<a href="${tomcatDocUrl}admin/viewPlan.html?planId=${associatedPlan.planId}&deptId=${department.deptNo}"> View</a>
					                        					...
					                        					<td>
					                        						...
					                        						<a href="${tomcatDocUrl}admin/setToDefaultPlan.html?planId=${associatedPlan.planId}&deptId=${department.deptNo}"> set </a>
