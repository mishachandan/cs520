            ...
            <div id="lower">
                <div id="low-docs">
                    <div class="curved container">
                        ...
                        <br/>
                        <form method="post" action="${tomcatDocUrl}AddCheckPoint" >
			
							<table border =1 width='100%'>
								<tr>
									<td>Runway: </td>
									<td> <select name="runway" >
											<c:forEach var="runway" items="${applicationScope.plan.runwayList }" varStatus="countRunway">
												<option value="${countRunway.index}">${runway.desc} </option> 
											</c:forEach>
										</select></td>
								</tr>
								<tr>
									...
									<td> <select name="stage">
											<c:forEach var="stage" items="${applicationScope.plan.stageList }" varStatus="countStage">
												<option value="${countStage.index }">${stage.desc } </option> 
											</c:forEach>
										</select></td>
								</tr>
								<tr>
