            ...
            <div id="lower">
                <div id="low-docs">
                    <div class="curved container">
                        <h4><a href="../reloadlogin.html"> Golden Eagle Flight Plan </a> > <a href="viewPlan.html?planId=${sessionScope.sessionPlanId}&deptId=${sessionScope.sessionDeptId}" >View Plan </a> ><a href="saveRunway.html">Create Runway</a> > Edit Runway
