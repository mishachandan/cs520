            ...
            <div id="lower">
                <div id="low-docs">
                    <div class="curved container">
                        ...
                        <br/>
                        <form method="post" action="EditCheckpoint" >
						<c:if test="${not empty applicationScope.plan}">
							<table border =1 width='100%'>
								...
								<tr>
									<td>Check Point: </td>
									<td><input type="text"  value="${requestScope.checkpoint }" name="checkpoint" /></td>
								</tr>
								<tr>
	
									<input type="hidden" name="row"  value="${requestScope.stage }"/>
									<input type="hidden" name="col"  value="${requestScope.runway }"/>
									<input type="hidden" name="checkpointindex"  value="${requestScope.checkpointindex }"/>
									
									<td colspan="2"><center><input type="submit" name="submit" value="Delete"> <input type="submit" name="submit" value="Save"> </center></td>
